...
![task](https://img.shields.io/badge/Task-Intermediate%201-blue)
![type](https://img.shields.io/badge/Type-Multi--class%20Classification-brightgreen)
![model](https://img.shields.io/badge/Model-MLP%20Neural%20Network-orange)
![metric](https://img.shields.io/badge/Accuracy-0.96-success)

---

## 📌 Problem Statement

Build a digit classification pipeline using the **MNIST dataset** that takes an input image of a handwritten digit and outputs the predicted digit (0–9).  
...
✅ **Test Accuracy Achieved:** `0.96` (during test runs)
...
This project demonstrates an end-to-end MNIST digit classification pipeline using a simple neural network.  
With correct preprocessing, loss setup, and training, a lightweight MLP achieves strong performance (~96% accuracy) without requiring complex architectures.
